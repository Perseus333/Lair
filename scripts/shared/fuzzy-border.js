document.addEventListener('DOMContentLoaded', function() {
    setTimeout(function() {
        ...
        const pixelSize = 4;
        const spreadDistance = 44; // Distance from the rectangle to spread pixels
        ...
        function calculateDensity(distance) {
            return Math.max(0.1, 1 - (Math.pow(distance, 3) / Math.pow(spreadDistance, 3))); // Adjust the formula as needed
        }
        ...
        function generateFuzzyOutline() {
            ...
            svgCanvas.setAttribute('class', 'svg-background'); // Apply the class here
